...
(function() {
  ...
  window.plSaveChanges = function() {
    ...
    clone.querySelectorAll("[contenteditable]").forEach(function(el){el.removeAttribute("contenteditable");el.style.cursor=el.style.outline=el.style.background="";});
  ...
  function plExitEditMode() {
    ...
    document.querySelectorAll("[contenteditable]").forEach(function(el){if(!el.closest("#plEditor")){el.removeAttribute("contenteditable");el.style.cursor=el.style.outline=el.style.background="";}});
